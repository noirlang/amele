    ...
    C: Fn() -> bool,
{
    ...
    let source = memory_source.ok_or_else(|| {
        "Cihazda okunabilir bir çekirdek bellek arayüzü (/proc/kcore, /dev/mem, /dev/kmem) bulunamadı. Çekirdek bu erişimi engelliyor.".to_string()
    })?;
